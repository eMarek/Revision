...
Algoritmi za iskanje razlik v besedilu se uporabljajo za zaznavanje sprememb, ki nastanejo, ko uporabnik ureja besedilo. Preprost primer razlike med dvema besedila je prikazan na Sliki \ref{diff1}.

\begin{figure}[placement h]
\begin{center}
\includegraphics[width=10cm]{diff1.png}
\end{center}
...
Besedilo, ki je skupno tako izvirnemu kot tudi spremenjenemu besedilu, imenujemo najdaljše skupno zaporedje (ang. longest common subsequence). V našem primeru to zaporedje sestavljajo črke “{\tt Leloil}”. Na Sliki \ref{diff1} so to črke v razliki, ki niso ne prečrtane ne podčrtane. Med izvirnim besedilom in spremenjenim besedilom lahko izračunamo tudi Levenshteinovo razdaljo. To je številka, ki pove, koliko sprememb bi morali narediti na izvirnemu besedilu, da dobimo spremenjeno besedilo. Levenshteinovo razdalja našega primera je 12. Na Sliki \ref{diff1} lahko vidimo sedem prečrtanih črk in pet podčrtanih črk. Skupaj torej 12 sprememb, sedemkrat brisanja in petkrat vstavljanje. Na podlagi najdaljšega skupnega zaporedja in Levenshteinovo razdalje lahko predvidimo scenarij najkrajšega urejanja (ang. shortest edit script). To bi bili  {\tt \{ Pobriši ‘ta’ \}}, {\tt \{ Vstavi ‘do’ \}}, {\tt \{ Pobriši ‘nos’ \}}, {\tt \{ Vstavi ‘m’ \}}, {\tt \{ Pobriši ‘ka’ \}}, {\tt \{ Vstavi ‘ec’ \}}. Ali so to res operacije, kot jih je naredil uporabnik, ne vemo. Dejstvo pa je, da so to spremembe v besedilu. Uporabnik, bi lahko v celoti pobrisal besedo “{\tt Letalonosilka}” in na novo napisal “{\tt Ledolomilec}”. Problem, ki ga rešujemo, je zagotavljanje konsistentnost med uporabniki. Ne zanima nas katere operacije so se zgodile v urejevalniku. Ni pomemebno kako je uporabnik uredil besedilo. Pomembno je vsebina besedila. Za to je dovolj, da ugotavljamo le kakšne so spremembe v besedilu in ne kako smo prišli do njih.
...
Fusce accumsan, massa a mollis eleifend, sapien lectus commodo lectus, vitae venenatis ipsum diam at risus. Suspendisse potenti. Duis quis convallis augue.
