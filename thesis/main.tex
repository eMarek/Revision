...
\usepackage[font=footnotesize]{caption} % majhna velikost pisave pri opisih slik
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% izvorna koda
\lstset{
	basicstyle=\linespread{.94}\footnotesize\ttfamily, % pomanjšana pisava in monospace
...
\begin{center}
	...
	\vskip 1em
	{\huge\bf Primerjava algoritmov za usklajevanje besedil pri skupinskem urejanju \par}
	\vskip 2em
	...
	\vfill
	{\large \textsc{Mentor}: izr. prof. dr. Zoran Bosnić \par}
	\vskip 2em
